...
const Carousels = ({data}) => {
    ...
    return (
      <Box>
        <Typography
          sx={{ marginLeft: "100px", paddingBottom: "30px",display:"flex",gap:2 }}
          variant="h5"
        >
          <img style={{width:"30px",height:"30px"}} src="https://www.xentice.com/static/media/commercial_space.cabcda3f.png" />
          Commercial Shop
        </Typography>
        ...
        >
          {data?.map((item) =>
            JSON.parse(item.propertyType)?.name === "Commercial Shop" ? (
              <>
