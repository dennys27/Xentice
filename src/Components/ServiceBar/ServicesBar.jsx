...
const ServicesBar = () => {
  return (
    <Box sx={{ height: "140px", marginTop: "30px" }}>
      <Container sx={{ display: "flex", justifyContent: "space-between" }}>
        ...
        >
          <img
            ...
            src="https://www.xentice.com/static/media/engineer.877f1aa6.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> Builders</Typography>
        </Box>
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/finance.15ca8db9.png"
            alt=""
          />
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/admin.e6b7a902.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> ITSupport</Typography>
        </Box>
        <Box
          sx={{
            height: "50px",
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/worker.ab3bc8e0.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> Labourers </Typography>
        </Box>
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/mentor.46f9b157.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> Mentors </Typography>
        </Box>
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/lawyer.f762a229.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> Advocates </Typography>
        </Box>
        <Box
          sx={{
            height: "50px",
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/wall.f25d47c0.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> Insurence </Typography>
        </Box>
        ...
        >
          <img
            style={{ width: "60%", height: "60%" }}
            src="https://www.xentice.com/static/media/woman.4c9f4456.png"
            alt=""
          />
          <Typography sx={{ fontSize: "14px" }}> Lyfestyle </Typography>
        </Box>
